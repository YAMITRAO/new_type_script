const SideBar_optional = () => {
  return (
    <div className="flex items-center md:flex-row flex-col justify-center overflow-x-hidden w-screen h-auto gap-5 p-10 space-x-6 bg-gray-300">
      {/* <!-- Component Start --> BlackBar Collapsed */}
      ...
      {/* <!-- Component Start white bar collapsed--> */}
      ...
      {/* <!-- Component Start white bar full --> */}
...
export default SideBar_optional;
